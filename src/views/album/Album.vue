    ...
    <div class="musicList">
      <el-tabs value="first">
        <el-tab-pane label="歌曲列表" name="first">
          ...
          <el-table :cell-class-name="cellClassFn" :data="albumInfo.songs" size="mini" style="width: 100%" @row-click="clickRow" @cell-click="clickCell" highlight-current-row stripe>
